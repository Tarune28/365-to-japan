...
function Contests() {
  ...
  const authorBios: { [key: string]: string } = {
    ...
    nicole:
      "Nicole is a current 11th grader from Vancouver, Canada. She started learning Japanese a year ago in school, and is looking forward to progressing with her language skills. Next year, she intends to visit Japan in order to improve her speaking skills.",
      ...
      <Container className="max-width-0">
        <Row className="pt-5 mt-5 mx-5">
          ...
          <Container className="max-width-0">
            <p className="description mb-5">
              [Released Nov. 2nd 22:42 EST]<br></br>
              <br></br>We are happy to announce that we received many
              submissions from 365toJapan readers for our inaugural contest.
              After weeks of judging, we decided on the following three
              selections for their strong connections to Japanese culture and
              vivid descriptions. These pieces will hold their place on
              365toJapan and represent the start of a haiku collection
              celebrated within our community. Thank you to everyone that
              participated, and be sure to watch out for our upcoming
              fall/winter contest!<br></br>
              <br></br> —365toJapan
            </p>
            <Row className="mx-auto" align={"middle"}>
              <Col lg={{span: 7}} md={{span: 15}} sm={{span:24}} xs={{span:24}} className="mx-2 py-2">
                <Card
                  title="Adam Haver"
                  extra={<InfoCircleOutlined onClick={() => showBio("adam")} />}
                >
              ...
              <Col lg={{span: 7}} sm={{span:24}} xs={{span:24}} className="mx-2 py-2">
                <Card
                  title={"Nicole Zhang"}
                  extra={
                    <InfoCircleOutlined onClick={() => showBio("nicole")} />
                  }
                >
              ...
              <Col lg={{span: 7}} sm={{span:24}} xs={{span:24}} className="mx-2 py-2">
                <Card
                  title={"Frank Amaya"}
                  extra={
                    <InfoCircleOutlined onClick={() => showBio("frank")} />
                  }
                >
        ...
        <AnimationOnScroll animateIn="animate__fadeIn" animateOnce={true}>
          ...
          <Row style={{ marginTop: "0px" }} className="mx-5">
            <Col lg={9} md={7} className="mx-5 mt-5">
              <ConfigProvider
                theme={{
                  token: {
                    colorPrimary: "#36B192",
            ...
            <Col lg={12} className=" mt-4">
              ...
              contest. Each contest follows some key notes. (a) The contest will
              only accept haiku and unfortunately not be able to consider other
              types of poetry/prose (b) The range of topics within haiku
              submissions is not restricted, but focusing on Japanese culture is
              encouraged (c) The results of the contest will be released
              approximately 2 months after the contest start. To be clear, at
              this point, publication will be online only—no print version is
              planned at this time.
              <br></br>
              <br></br>
              The contest will be hosted through 365toJapans itself. Each entry
              will be required to pay a fee of 3 dollars to enter the contest.
              The fee will be used to cover the cost of the prizes and the cost
              of the publication of the winning entries. The fee will be
              non-refundable. If the fee poses a significant financial hardship,
              please contact us at info@365tojapan.com in order to receive
              assistance.
            </Col>
          </Row>
        </AnimationOnScroll>
        <div>
          <Row className="pt-5 mx-5">
            <h3 className="contestHeader">Guidelines (subject to change)</h3>
            <ol>
              <li>
              ...
              <li>
                Anticipated 2 issues per year, with one spring/summer release
                and one fall/winter release
              </li>
              <li>
                All ages 13 and up will be allowed to submit, with
                parent/guardian permission required for authors under 18
              </li>
          ...
          <Row className="pt-3 mx-5">
            ...
            <p>
              ...
              winner with 50 dollars, the second place winner with 35 dollars,
              and the third place winner will receive 15 dollars (in Amazon gift
              cards). Furthermore, the top submissions will be spotlighted on
              this page of 365toJapan (and will not be removed).
            </p>
          </Row>
          <Row className="pt-3 mx-5">
            ...
            <p>
              ...
              judge being both native English/Japanese speaker. The judges will
              be selected based on their experience with haiku, their ability to
          ...
          <Row className="pt-3 mx-5 mb-5">
            <h3 className="contestHeader">Submissions</h3>
            <br></br>
            <br></br>
            <p>
              (Currently closed) Below, the submission spot for this contest can
              be found. Please follow all guidlines and note that you have read
              and met them with the checkbox at the end.
            </p>
